            ...
            <div className='grid md:grid-cols-3 mt-20 w-[96%] mx-auto gap-2'>
                ...
                <div>
                    <div className='px-3 bg-[#cdd1eb] rounded-md py-5'>
                        ...
                        <p className=' pl-1'><span className='font-bold'>Salary:</span> <span>{salary}</span></p>
                        <p className='pl-1'><span className='font-bold'>Job Title:</span> <span>{name}</span></p>
                        <p className=' text-xl font-bold pt-4 pb-2'>Contact Information</p>
                        <hr className='pb-2' />
                        <p className='pl-1'><span className='font-bold'>Phone:</span> <span>{phone}</span></p>
                        <p className='py-1 pl-1'><span className='font-bold'>Email:</span> <span>{email}</span></p>
                        <p className='pl-1'><span className='font-bold'>Address:</span> <span>{address}</span></p>
                    </div>
